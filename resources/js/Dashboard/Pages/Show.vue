    ...
    <PageLayout :pages="pages">
        ...
        <form class="flex flex-col flex-auto" @submit.prevent="submit">
            ...
            <div class="flex flex-row justify-between w-full mb-4">
                ...
                <div @click="deletePage" class="bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600 transition cursor-pointer">Delete this page</div>
            </div>
  ...
  components: {
    ...
    methods: {
        ...
        deletePage() {
            let page = this.page
            page._method = 'delete'
            let form = useForm(this.page)
            form.post(route('dashboard.page.destroy', this.form.id))
        }
    },
    created() {
