<template>
    ...
    <layout>
        ...
        <div class="flex flex-col rounded-lg bg-light dark:bg-dark">
            ...
            <Link v-for="page in pages" :key="page.id" :href="route('dashboard.page.show', page.id)" class="flex flex-col sm:flex-row border-b border-light-100 dark:border-dark-100 hover:bg-white dark:hover:bg-black transition cursor-pointer">
                ...
                <div class="flex flex-1 justify-center items-center p-2 sm:p-4">{{ createdAt(page.created_at).locale('de').format('LL') }}</div>
            </Link>
