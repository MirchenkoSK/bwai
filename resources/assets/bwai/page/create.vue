<template>
    <layout>
        ...
        <template #breadcrumbs>
            ...
            <bw-breadcrumb>Create</bw-breadcrumb>
        </template>
        ...
        <form class="flex flex-col w-full max-w-4xl mx-auto rounded-lg bg-light dark:bg-dark" @submit.prevent="submit">
            ...
            <div class="flex flex-col p-4">
                ...
                <div class="flex flex-col w-full mb-4">
                    ...
                    <bw-textarea id="text" type="text" v-model="form.text" placeholder="Lorem ipsum dolor sit amet" />
                </div>
...
export default {
    ...
    setup(props) {
        ...
        const submit = () => form.post(route('dashboard.page.store'))

        return { form, hasErrors, progress, submit }
    }
}
</script>